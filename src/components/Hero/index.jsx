...
const Hero = () => {
    return (
        <>
            <div  id='home' className="h-screen overflow-x-hidden relative -mt-32">
                ...
                <div className="bg-herobg bg-center bg-no-repeat bg-cover h-screen   " >
                    ...
                    <div className="relative z-10 container mx-auto flex flex-col items-start justify-center h-full text-center text-white px-6">
                        <h1 className="text-5xl md:text-6xl lg:text-[60px] text-start font-bold max-w-3xl">
                        ...
                        <div className="mt-6 flex gap-4">
                            ...
                            <button className="px-6 py-3 underline  rounded-full font-semibold  hover:text-black transition">
                                Show Display Map
                            </button>
                        </div>
